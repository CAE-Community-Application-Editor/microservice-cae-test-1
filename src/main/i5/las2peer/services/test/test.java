...
public class test extends RESTService {
  ...
  @Api
  @SwaggerDefinition(
      info = @Info(title = "cae-test-1", version = "$Metadata_Version$",
          description = "$Metadata_Description$",
          termsOfService = "$Metadata_Terms$",
          contact = @Contact(name = "test", email = "CAEAddress@gmail.com") ,
          license = @License(name = "BSD",
              url = "https://github.com/CAE-Community-Application-Editor/microservice-cae-test-1/blob/master/LICENSE.txt") ) )
  @Path("/")
